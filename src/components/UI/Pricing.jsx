  ...
  return <section id='pricing-plan'>
    <div className="container">
        <div className="pricing__top">
            <h2 className="section__title"> Gym <span className="higlights">Pricing</span> Plan </h2>
           <p>Lorem ipsum dolor sit amet consectetur adipisicing <br /> Minima cupiditate quod asperiores. Aliquid, vel dolore!</p>
        </div>
        ...
        <div className="pricing__wrapper">
         ...
         data-aos-duration='2000'>
            ...
            <div className="pricing__item pricing__item-03" data-aos='fade-up'
         data-aos-duration='1800'>
                <div className="pricing__card-top">
